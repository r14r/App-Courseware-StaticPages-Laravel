...
Route::get('/data/{path}', [DataController::class, 'show'])
    ->where('path', '.*')
    ->name('data.show');
Route::post('/data/{path}', [DataController::class, 'store'])
    ->where('path', '.*')
    ->name('data.store');
Route::put('/data/{path}', [DataController::class, 'update'])
    ->where('path', '.*')
    ->name('data.update');
Route::delete('/data/{path}', [DataController::class, 'destroy'])
    ->where('path', '.*')
    ->name('data.destroy');
